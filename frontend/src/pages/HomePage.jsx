    ...
    <div className="page-container">
      ...
      <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
        <div className="card text-center">
          ...
          <h3 className="font-semibold text-gray-900 mb-1">丰富的常识库</h3>
          <p className="text-sm text-gray-500">覆盖时间、空间、社交、消费等 8 大类日常生活常识</p>
        </div>
        <div className="card text-center">
          <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center mx-auto mb-3">
            <Clock className="w-5 h-5 text-gray-700" />
          </div>
          <h3 className="font-semibold text-gray-900 mb-1">智能语义理解</h3>
          <p className="text-sm text-gray-500">精准识别模糊时间词、社交潜台词等隐性语义</p>
        </div>
        <div className="card text-center">
          <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center mx-auto mb-3">
            <Shield className="w-5 h-5 text-gray-700" />
          </div>
          <h3 className="font-semibold text-gray-900 mb-1">认知陷阱提醒</h3>
          <p className="text-sm text-gray-500">每条常识附带认知陷阱解析，帮你避免常见误区</p>
        </div>
      </div>
    </div>
  )
